...
def main() -> None:
    ...
    report = {
        ...
        "gates": {
            ...
            "bounded_executor_queue": "passed",
            "worker_owned_mutation": "passed",
            "deterministic_queue_full_backpressure": "passed",
            "fifo_intent_ordering": "passed",
            "concurrent_conflicts_fail_closed": "passed",
            "bounded_latency_samples": "passed",
            "shutdown_rejects_new_intents": "passed",
            "sanitized_concurrency_metrics": "passed",
            "parallel_pre_admission_workers": "passed",
            "bounded_verification_queue": "passed",
            "pre_admission_signature_hash_checks": "passed",
            "ordered_mutation_dispatch": "passed",
            "mutation_revalidation_required": "passed",
            "pre_admission_failure_no_mutation": "passed",
            "verification_latency_metrics_bounded": "passed",
            "verification_stress_sanitized": "passed",
            "adaptive_limiter_bounded": "passed",
            "limiter_rejection_typed": "passed",
            "no_intent_id_on_limited": "passed",
            "parsed_verifying_keys_reused": "passed",
            "context_fingerprint_bound_cache": "passed",
            "freshness_rechecked_on_cache_hit": "passed",
            "validation_failure_adapts_capacity": "passed",
            "sanitized_admission_metrics": "passed",
            "signed_lease_migration_intent": "passed",
            "distinct_lease_migration_witness_quorum": "passed",
            "source_drain_before_prepare": "passed",
            "source_release_before_activation": "passed",
            "destination_epoch_strictly_increases": "passed",
            "lease_migration_replay_conflict_safe": "passed",
            "lease_migration_stale_evidence_rejected": "passed",
            "lease_migration_snapshot_recovery_safe": "passed",
        },
        ...
        "phase44_ownership_bound_cas_executor": {
            "bounded_executor_queue": True,
            "worker_owned_mutation": True,
            "deterministic_queue_full_backpressure": True,
            "fifo_intent_ordering": True,
            "concurrent_conflicts_fail_closed": True,
            "bounded_latency_samples": True,
            "shutdown_rejects_new_intents": True,
            "sanitized_concurrency_metrics": True,
            "secret_material_recorded": False,
            "cluster_mutation_performed": False,
        },
        "phase45_ownership_bound_cas_verifier": {
            "parallel_pre_admission_workers": True,
            "bounded_verification_queue": True,
            "pre_admission_signature_hash_checks": True,
            "ordered_mutation_dispatch": True,
            "mutation_revalidation_required": True,
            "pre_admission_failure_no_mutation": True,
            "verification_latency_metrics_bounded": True,
            "verification_stress_sanitized": True,
            "secret_material_recorded": False,
            "cluster_mutation_performed": False,
        },
        "phase46_ownership_bound_cas_admission": {
            "adaptive_limiter_bounded": True,
            "limiter_rejection_typed": True,
            "no_intent_id_on_limited": True,
            "parsed_verifying_keys_reused": True,
            "context_fingerprint_bound_cache": True,
            "freshness_rechecked_on_cache_hit": True,
            "validation_failure_adapts_capacity": True,
            "sanitized_admission_metrics": True,
            "secret_material_recorded": False,
            "cluster_mutation_performed": False,
        },
        "phase47_lease_migration": {
            "signed_intent_binding": True,
            "distinct_witness_quorum": True,
            "source_drain_enforced": True,
            "release_before_activation": True,
            "strict_destination_epoch": True,
            "replay_and_conflict_safe": True,
            "expiry_and_stale_evidence_rejected": True,
            "durable_snapshot_partition_safe": True,
            "secret_material_recorded": False,
            "cluster_mutation_performed": False,
        },
        ...
        "security_notes": {
            ...
            "ownership_bound_cas_executor_mode": "bounded worker-owned FIFO executor with sanitized contention metrics",
            "ownership_bound_cas_verifier_mode": "parallel read-only pre-admission verification with ordered lock-held mutation revalidation",
            "ownership_bound_cas_admission_mode": "bounded adaptive admission with context-bound parsed-key verification facts and live freshness checks",
        },
    }
