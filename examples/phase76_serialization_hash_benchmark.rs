...
struct Row {
    ...
    stream_bytes: usize,
    payload_bytes: usize,
    canonical_payload_serialize_p50_ns: u64,
    canonical_payload_serialize_p95_ns: u64,
    canonical_payload_serialize_p99_ns: u64,
    sha256_integrity_p50_ns: u64,
    sha256_integrity_p95_ns: u64,
    sha256_integrity_p99_ns: u64,
    wire_serialize_and_integrity_p50_ns: u64,
    wire_serialize_and_integrity_p95_ns: u64,
    wire_serialize_and_integrity_p99_ns: u64,
...
fn main() {
    ...
    for frames in FRAME_COUNTS {
        ...
        let wire_times = measure(SAMPLES, || {
            black_box(diagnostic_stream.to_json().expect("wire"));
        });
        ...
        rows.push(Row {
            ...
            canonical_payload_serialize_p50_ns: percentile(&mut canonical_times.clone(), 0.50),
            canonical_payload_serialize_p95_ns: percentile(&mut canonical_times.clone(), 0.95),
            canonical_payload_serialize_p99_ns: percentile(&mut canonical_times.clone(), 0.99),
            ...
            wire_serialize_and_integrity_p50_ns: percentile(&mut wire_times.clone(), 0.50),
            wire_serialize_and_integrity_p95_ns: percentile(&mut wire_times.clone(), 0.95),
            wire_serialize_and_integrity_p99_ns: percentile(&mut wire_times.clone(), 0.99),
